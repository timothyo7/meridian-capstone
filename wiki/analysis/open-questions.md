...
| Q26 | Does Meridian sell owned-brand or private-label products, and how much do prepared foods contribute to sales and margin? | Dana | [differentiation](../concepts/differentiation.md) | Industry research treats private label and prepared foods as the main differentiators; the brief names prepared foods but gives no numbers and does not mention owned brands | open |
...
| Q27 | Can store-by-week sales totals be adjusted for food price inflation (e.g., the BLS food-at-home CPI for Los Angeles) to separate price growth from volume growth? | team | [store-performance-variation](../concepts/store-performance-variation.md) | Industry dollar sales grew in 2025 while volumes fell; unadjusted totals could show growth that is really price | deferred |
